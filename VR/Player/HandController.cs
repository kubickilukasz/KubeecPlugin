...
namespace Kubeec.VR.Interactions {
    public class HandController : MonoBehaviour {
        ...
        public void Init(CharacterHandSetup setup, Camera camera, bool isRightHand, bool isOwner) {
            this.setup = setup;
            this.camera = camera;
        ...
        public void IgnoreCollision(Collider[] colliders) {
            foreach (Collider col in colliders) {
                Physics.IgnoreCollision(col, collider, true);
            }
        }

        public void ResetHand(bool canRaycast = true) {
            this.canRaycast = canRaycast;
            handInteractor.Clear();
        }
        ...
        void RaycastAttractable() {
            if (canRaycast && !handTracker.IsPosAndRotOverrided && isOwner && !handInteractor.IsInteract()) {
